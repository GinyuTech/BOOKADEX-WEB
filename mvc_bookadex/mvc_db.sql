...
CREATE TABLE Usuario(
	Id INT AUTO_INCREMENT,
	StatusConta BOOLEAN DEFAULT 1,
	TipoConta INT(1) DEFAULT 0, -- 0: Usuário Padrão; 1: Admin; 2: Moderador
...
INSERT INTO Usuario (NomeUsuario, Apelido, Email, Senha, Telefone)
VALUES ('Gustavo Hirota Alves Velho', 'dethstruck', 'gustavohirotaalves@gmail.com', '12345678', '11981302015');
INSERT INTO Usuario (NomeUsuario, Apelido, Email, Senha, Telefone)
VALUES ('Matheus Cavalcanti', 'mataplays', 'matheuscavalcanti@gmail.com', '12345678', '11283948193');
INSERT INTO Livro (NomeLivro, Sinopse, Autor, DataLancamento)
VALUES ('Pequeno Princípe', 'Lorem Ipsum', 'Silas','2003-10-09'); -- Corrigir no MER, Livro não tem AcessoLivro
